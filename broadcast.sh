...
# Write .env (only set GOOGLE_APPLICATION_CREDENTIALS if an explicit JSON file exists)
{
  ...
  echo "GCP_KEY=${GOOGLE_APPLICATION_CREDENTIALS_PATH}"
  ...
  echo "ALLOW_SYNTHETIC_FALLBACK=false"
} > "${APP_DIR}/.env"
